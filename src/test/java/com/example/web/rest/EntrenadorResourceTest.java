...
public class EntrenadorResourceTest {
    ...
    public void initTest() {
        ...
        entrenador.setFecha(DEFAULT_FECHA);
    }
    ...
    public void createEntrenador() throws Exception {
        ...
        assertThat(testEntrenador.getFecha()).isEqualTo(DEFAULT_FECHA);
    }
    ...
    public void updateEntrenador() throws Exception {
        ...
        entrenador.setFecha(UPDATED_FECHA);
        ...
        assertThat(testEntrenador.getFecha()).isEqualTo(UPDATED_FECHA);
    }
