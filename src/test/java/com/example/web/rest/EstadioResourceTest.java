...
public class EstadioResourceTest {
    ...
    public void initTest() {
        ...
        estadio.setUbicacion(DEFAULT_UBICACION);
    }
    ...
    public void createEstadio() throws Exception {
        ...
        assertThat(testEstadio.getUbicacion()).isEqualTo(DEFAULT_UBICACION);
    }
    ...
    public void updateEstadio() throws Exception {
        ...
        estadio.setUbicacion(UPDATED_UBICACION);
        ...
        assertThat(testEstadio.getUbicacion()).isEqualTo(UPDATED_UBICACION);
    }
