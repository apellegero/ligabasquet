...
angular.module('ligabasquetApp').controller('EquipoDialogController',
    ['$scope', '$stateParams', '$modalInstance', '$q', 'entity', 'Equipo', 'Socio', 'Entrenador', 'Estadio', 'Jugador', 'Temporada',
        function($scope, $stateParams, $modalInstance, $q, entity, Equipo, Socio, Entrenador, Estadio, Jugador, Temporada) {
